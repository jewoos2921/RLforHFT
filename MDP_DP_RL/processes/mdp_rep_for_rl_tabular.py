...
from typing import Set, Callable, Mapping, Tuple
from src.processes.mp_funcs import get_rv_gen_func_single
from src.processes.mdp_rep_for_rl_fa import MDPRepForRLFA
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            init_state_action_gen=get_rv_gen_func_single(
                {(s, a): 1. / sum(len(v) for v in self.state_action_dict.values())
