from typing import NamedTuple, Optional, Sequence, Callable, Tuple
from src.func_approx.dnn_spec import DNNSpec
from src.func_approx.dnn import DNN
from src.func_approx.func_approx_base import FuncApproxBase
from src.func_approx.linear_approx import LinearApprox
...
class FuncApproxSpec(NamedTuple):
    ...
    adam_params: Tuple[bool, float, float] = (True, 0.9, 0.999)
